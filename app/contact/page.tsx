...
// --- UI Primitives (matches your style) ---
const Button = ({
  children,
  variant = "primary",
  className = "",
...
const Input = ({
  ...
  >
    <label className="block text-sm font-semibold text-gray-200 flex items-center gap-2">
      {Icon && <Icon className="w-4 h-4 text-purple-400" />} {label}
    </label>
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/xanbaqrg", {
        method: "POST",
        body: form,
      ...
      console.error(err);
      alert(
        "There was an issue submitting the form. Please try again or email me directly."
      );
    } finally {
  ...
  return (
    <main className="min-h-svh bg-[radial-gradient(60%_80%_at_50%_0%,rgba(88,101,242,0.25),rgba(0,0,0,0)_60%),linear-gradient(180deg,#0a0a0a,#0a0a0a)] text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="hidden md:block absolute top-20 left-10 w-72 h-72 bg-purple-500/10 rounded-full blur-3xl animate-pulse" />
        <div className="hidden md:block absolute bottom-20 right-10 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse" />
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 pt-20 text-center">
          ...
          <p className="mt-4 text-gray-300 text-base sm:text-lg">
            Tell me about your project and I'll send a free audit + strategy
            within 24 hours.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-500/20 to-orange-500/20 backdrop-blur-sm border border-red-500/30 rounded-full px-6 py-3">
            ...
            <span className="text-orange-200 font-medium text-xs sm:text-sm">
      ...
      <div className="mx-auto max-w-5xl px-4 pb-12">
        <div className="flex justify-between items-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Tanveer Singh</p>
